"""deepfake_detection_on_social_media URL Configuration
...
from deepfake_detection_on_social_media import settings
...
urlpatterns = [
    ...
    url(r'^Predict_Tweet_Type/$', remoteuser.Predict_Tweet_Type, name="Predict_Tweet_Type"),
    ...
    url(r'^View_Predicted_Tweet_Type_Ratio/$', serviceprovider.View_Predicted_Tweet_Type_Ratio, name="View_Predicted_Tweet_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Tweet_Type/$', serviceprovider.View_Predicted_Tweet_Type, name="View_Predicted_Tweet_Type"),
