...
ROOT_URLCONF = 'deepfake_detection_on_social_media.urls'
...
WSGI_APPLICATION = 'deepfake_detection_on_social_media.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'deepfake_detection_on_social_media',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
